      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img src="{{ backpack_avatar_url(backpack_user()) }}" class="img-circle" alt="User Image">
          </div>
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            <a href="#"><i class="fa fa-list-ul"></i> <span>{{ trans('order.orders') }}</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
              ...
              @if(backpack_user()->can('list_order_statuses'))
              ...
              @endcan
              @if(backpack_user()->can('list_currencies'))
              ...
              @endcan
              @if(backpack_user()->can('list_carriers'))
              ...
              @if(backpack_user()->can('list_taxes'))
          ...
          <li class="treeview">
            <a href="#"><i class="fa fa-list"></i> <span>{{ trans('product.products') }}</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
              @if(backpack_user()->can('list_products'))
              ...
              @if(backpack_user()->can('list_categories'))
              ...
              @if(backpack_user()->can('list_units'))
              <li><a href='{{ backpack_url('units') }}'><i class='fa fa-tag'></i> <span>{{ trans('unit.units') }}</span></a></li>
              @endcan

              @if(backpack_user()->can('list_attribute_sets'))
              ...
              @if(backpack_user()->can('list_attributes'))
              ...
              @if(backpack_user()->can('list_brands'))
              <li><a href='{{ backpack_url('brands') }}'><i class='fa fa-tag'></i> <span>{{ trans('brand.brands') }}</span></a></li>
              @endcan
            </ul>
          </li>

          <li class="treeview">
            <a href="#"><i class="fa fa-list-ul"></i> <span>Clients</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
              @if(backpack_user()->can('list_clients'))
                <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/clients') }}"><i class="fa fa-users"></i> <span>{{ trans('client.clients') }}</span></a></li>
              @endcan

              @if(backpack_user()->can('list_client_types'))
                <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/client-types') }}"><i class="fa fa-users"></i> <span>{{ trans('client_type.client_types') }}</span></a></li>
              @endcan

              @if(backpack_user()->can('list_client_areas'))
                <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/client-areas') }}"><i class="fa fa-users"></i> <span>{{ trans('client_area.client_areas') }}</span></a></li>
              @endcan
            </ul>
          </li>
          ...
          <li class="treeview">
            <a href="#"><i class="fa fa-list-ul"></i> <span>Promotions</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
              @if(backpack_user()->can('list_cart_rules'))
              ...
              @if(backpack_user()->can('list_specific_prices'))
          ...
          @if(backpack_user()->can('list_notification_templates'))
